...
1	audio_tracks	Audio tracks	http://example.com
\.
...
SELECT pg_catalog.setval('category_seq', 1, true);
...
25	tr_private	{"description":"Private track description","categoryId":"1", "hname":"My private track"}	http://example.com	8
\.
...
9	delzex@gmail.com	delzex@gmail.com	delzex@gmail.com
\.
...
SELECT pg_catalog.setval('users_seq', 9, true);
